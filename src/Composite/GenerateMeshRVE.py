...
fm_max_default_no_mirror = 2.5
fc_mesh_min_d_no_mirror = {
    "A": 0.2,
    "Adouble": 0.5,
    "B": 0.2,
    "B1":0.5,
...
def GenerateMeshRVE(lines,select_design,output_folder,params_composite):
    ...
    if params_composite["mirror"]:
        params_composite["fc_mesh_min"] = fc_mesh_min_d[select_design]
        params_composite["fc_mesh_max"] = fc_mesh_max_d[select_design]
    else:
        params_composite["fc_mesh_min"] = fc_mesh_min_d_no_mirror[select_design]
        params_composite["fc_mesh_max"] = fc_mesh_max_no_mirror[select_design]
