...
def CreateSimulation(design_folder,
    ...
    Ecarbon_MPa = Ecarbon_MPa/15 #22
    # Ecarbon_MPa = Ecarbon_MPa/2.5
    # Ecarbon_MPa = Ecarbon_MPa


    resina_data["young modulus [MPa]"] = resina_data["young modulus [MPa]"]/4
    ...
    print("Resina E: ", materials["matrix"]["E"])
    print("Carbon E: ", materials["carbon"]["E"])
    print("Nucleo E: ", materials["nucleo"]["E"])
    ...
    for ii_displ_y in np.linspace(0,displ_y,3):
        ...
        istep.CreateBoundary(YL_PLANE_NSET,dim=2,displ=ii_displ_y)
